...
def listar_dados(nome, celular, email):
      print("Nome: %s Celular: %s Email: %s" % (nome, celular, email))
      print("---------------------------")
...
def pesquisar():
    ...
    if p != None:
        ...
        listar_dados(nome, celular, email)
         ...
         #exibe a mensagem de insucesso a procura do registro
...
def apagar():
     global agenda
     nome = p_nome()
     # retorna o índice do meu nome ou vazio
     p = pesquisa(nome)
...
def editar():
     ...
     if p != None:
          # mostra o nome e pede a adição dos demais
          nome = agenda[p][0]
          print("Nome........:" , nome)
          celular = input("Celular....:")
          email = input("E-mail.....:")
